...
ax1.hist(data_non_hab['P. Ts Mean (K)'], bins, alpha=0.5, label='NH')
ax1.hist(data_psychro['P. Ts Mean (K)'], bins, alpha=0.5, label='P')
ax1.hist(data_meso['P. Ts Mean (K)'], bins, alpha=0.5, label='M')
ax1.legend(loc='upper right')
#ax1.xlabel("Mean Surface Temperature (K)")
ax1.set_title("Mean Surface Temperature (K)")
#ax1.ylabel("Frequency of Occurrence")
#plt.grid()
#ax.plot(plt)
#plt.show()
...
ax2.hist(data_psychro['P. Mass (EU)'], bins, alpha=0.5, label='Psychroplanet')
ax2.hist(data_meso['P. Mass (EU)'], bins, alpha=0.5, label='Mesoplanet')
ax2.legend(loc='upper right')
#ax2.xlabel("Mass of Planet")
#ax2.ylabel("Frequency of Occurrence")
ax2.set_title("Mass of Planet")
#plt.grid()~~~
#plt.show()
...
ax3.hist(data_psychro['S. [Fe/H]'], bins, alpha=0.5, label='Psychroplanet')
ax3.hist(data_meso['S. [Fe/H]'], bins, alpha=0.5, label='Mesoplanet')
ax3.legend(loc='upper right')
ax2.set_title("S. Fe/H")
#ax3.xlabel("S. Fe/H")
#plt.ylabel("Frequency of Occurrence")
#plt.grid()~~~
#plt.show()
...
ax4.hist(data_psychro['P. HZA'], bins, alpha=0.5, label='Psychroplanet')
ax4.hist(data_meso['P. HZA'], bins, alpha=0.5, label='Mesoplanet')
